...
export const REALMS = [
  ...
  },
  {
    ...
    line: "Gem's dominion. Archives, logic, and the long watch.",
    sister: "gem",
  ...
  },
  {
    id: "valorheart",
    name: "Valorheart",
    petal: "Strength & Vigil",
    cost: "Loyalty. You do not enter unarmed or untrue.",
    line: "A realm of shields, hearths, and the people who keep watch.",
    sister: "jewel",
    pillar: "Heart" as Pillar,
    root: "Purpose" as RootName,
    image: "/canon/rooms/jewel-nest.jpg",
  },
  {
    ...
    line: "Cosmic order and the council that keeps the Pattern straight.",
    sister: "gem",
    pillar: "Crown" as Pillar,
    root: "Legacy" as RootName,
    image: "/canon/atlas.jpg",
  ...
  },
  {
    ...
    line: "Ritual purity, sacred endings, and the climb after grief.",
    sister: "aida",
    pillar: "Throat" as Pillar,
    root: "Growth" as RootName,
    image: "/canon/atlas.jpg",
